...
{
    public class sdb_reel_slateMap : EntityTypeConfiguration<sdb_reel_slate>
    {
        public sdb_reel_slateMap()
        {
            // Primary Key
            this.HasKey(t => t.reel_slate_id);
            ...
            this.Property(t => t.reel_slate_id)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            // Table & Column Mappings
            this.ToTable("sdb_reel_slate");
