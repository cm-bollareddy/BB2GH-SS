...
{
    public class nola_plt_report_configMap : EntityTypeConfiguration<nola_plt_report_config>
    {
        public nola_plt_report_configMap()
        {
            // Primary Key
            ...
            this.ToTable("nola_plt_report_config");
