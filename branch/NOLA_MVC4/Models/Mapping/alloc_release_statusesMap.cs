...
{
    public class alloc_release_statusesMap : EntityTypeConfiguration<alloc_release_statuses>
    {
        public alloc_release_statusesMap()
        {
            // Primary Key
            ...
            this.ToTable("alloc_release_statuses");
