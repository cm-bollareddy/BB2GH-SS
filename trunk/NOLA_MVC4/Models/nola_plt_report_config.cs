...
{
    public partial class nola_plt_report_config
    {
        ...
        public string report_sched_id5 { get; set; }
        public string report_sched_id6 { get; set; }
        public string report_sched_id7 { get; set; }
