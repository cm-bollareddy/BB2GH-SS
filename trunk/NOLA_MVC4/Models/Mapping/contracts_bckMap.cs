...
{
    public class contracts_bckMap : EntityTypeConfiguration<contracts_bck>
    {
        public contracts_bckMap()
        {
            // Primary Key
            this.HasKey(t => new { t.contract_number, t.date_created, t.pba_contact_code, t.obd, t.reporting_complete, t.outstanding_payments, t.season_description, t.num_episodes, t.focus_code, t.funding_area, t.program_title, t.season_number, t.nola, t.lic_name, t.lic_address_1, t.lic_address_2, t.lic_address_3, t.lic_city, t.lic_state, t.lic_zip, t.lic_email, t.lic_country, t.lic_fax, t.lic_voice_phone, t.lic_voice_ext, t.ptv_unlimited, t.num_ptv_releases, t.num_ptv_rlse_term, t.num_ptv_rlse_term_ymdh, t.ptv_perpetuity, t.sch_off_air_record, t.sch_off_air_term, t.sch_off_air_term_ymdh, t.sch_off_air_eb_ob, t.canadian_holdback, t.canadian_holdback_term, t.can_holdback_term_ymdh, t.dbs, t.dbs_comment, t.online, t.online_term, t.online_term_ymdh, t.online_excl_nonexcl, t.online_adv_promo, t.online_cd_rom, t.online_int_nonint, t.online_text, t.audio_visual, t.audio_visual_text, t.av_broad_lic_area, t.av_comment, t.retail_home_video, t.retail_home_video_text, t.rt_hv_broad_lic_area, t.rt_hv_comment, t.direct_response, t.direct_response_text, t.dr_broad_lic_area, t.dr_comment, t.on_air_offer, t.ancillary_revenue, t.anc_rev_percentage, t.anc_percent_of_roi, t.anc_address_same_as_prod, t.anc_report_due, t.step_up_payments, t.first_dollar_gross, t.adjusted_gross, t.net, t.sharing_other, t.all_revenues, t.program_sales_only, t.program_related_sales, t.revenue_other, t.in_flight, t.in_flight_reversion, t.foreign_rights, t.commercial_cable, t.underwriting, t.merchandise, t.books, t.hdtv, t.spanish_language, t.total_budget, t.final_budget, t.sharing_comment, t.revenue_comment });
            ...
            this.Property(t => t.num_ptv_releases)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.num_ptv_rlse_term)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.num_ptv_rlse_term_ymdh)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.sch_off_air_term)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.sch_off_air_term_ymdh)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.sch_off_air_eb_ob)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.canadian_holdback_term)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.can_holdback_term_ymdh)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.online_term)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.online_term_ymdh)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.online_excl_nonexcl)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.online_int_nonint)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.anc_rev_percentage)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.anc_percent_of_roi)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.total_budget)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.final_budget)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
