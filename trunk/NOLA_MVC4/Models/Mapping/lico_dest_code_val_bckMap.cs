...
{
    public class lico_dest_code_val_bckMap : EntityTypeConfiguration<lico_dest_code_val_bck>
    {
        public lico_dest_code_val_bckMap()
        {
            // Primary Key
            this.HasKey(t => new { t.borrower_ship_code, t.borrower_ship_dept });
            ...
            this.ToTable("lico_dest_code_val_bck");
