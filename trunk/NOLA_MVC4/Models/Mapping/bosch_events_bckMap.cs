...
{
    public class bosch_events_bckMap : EntityTypeConfiguration<bosch_events_bck>
    {
        public bosch_events_bckMap()
        {
            // Primary Key
            this.HasKey(t => new { t.sched_index, t.sched_id, t.start_time, t.start_time_sec, t.@event_length, t.@event_length_sec, t.@event_length_indicator, t.@event, t.element_number, t.element_index, t.element_type, t.element_type_name, t.black_time, t.black_time_sec, t.uplink, t.current_distributor, t.black_start_time, t.black_effect, t.slate_start_time, t.slate_length, t.slate_effect, t.series_title, t.program_title, t.episode_title, t.origination_flag, t.live_origination, t.dolby, t.stereo_mono, t.sap, t.anti_clutter, t.rating, t.subrating, t.rating_start_time, t.feed_flag, t.feed_flag_desc, t.slate, t.program_comments, t.techeval_date, t.rundown_comments, t.subscript_rpt_trans, t.special_condition_desc, t.merged });
            ...
            this.ToTable("bosch_events_bck", "pdbnola");
