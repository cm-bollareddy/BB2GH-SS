...
{
    public class louth_pp_eventsMap : EntityTypeConfiguration<louth_pp_events>
    {
        public louth_pp_eventsMap()
        {
            // Primary Key
            this.HasKey(t => new { t.sched_id, t.start_time_sec });
