...
{
    public class alloc_update_statusesMap : EntityTypeConfiguration<alloc_update_statuses>
    {
        public alloc_update_statusesMap()
        {
            // Primary Key
            ...
            this.ToTable("alloc_update_statuses", "pdbnola");
