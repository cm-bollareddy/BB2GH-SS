...
{
    public class sdb_ancillary_materialsMap : EntityTypeConfiguration<sdb_ancillary_materials>
    {
        public sdb_ancillary_materialsMap()
        {
            // Primary Key
            this.HasKey(t => t.ancillary_key);
            ...
            this.Property(t => t.ancillary_key)
            ...
            this.ToTable("sdb_ancillary_materials");
