...
{
    public class sdb_episode_promo_subcatMap : EntityTypeConfiguration<sdb_episode_promo_subcat>
    {
        public sdb_episode_promo_subcatMap()
        {
            // Primary Key
            ...
            this.ToTable("sdb_episode_promo_subcat");
