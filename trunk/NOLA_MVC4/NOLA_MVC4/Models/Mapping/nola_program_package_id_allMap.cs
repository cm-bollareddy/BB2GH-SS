...
{
    public class nola_program_package_id_allMap : EntityTypeConfiguration<nola_program_package_id_all>
    {
        public nola_program_package_id_allMap()
        {
            // Primary Key
            ...
            this.ToTable("nola_program_package_id_all");
