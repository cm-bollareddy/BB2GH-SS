...
{
    public class current_video_programsMap : EntityTypeConfiguration<current_video_programs>
    {
        public current_video_programsMap()
        {
            // Primary Key
            ...
            this.ToTable("current_video_programs", "pdbnola");
