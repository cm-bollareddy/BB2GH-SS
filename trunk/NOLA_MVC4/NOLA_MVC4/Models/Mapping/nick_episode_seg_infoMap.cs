...
{
    public class nick_episode_seg_infoMap : EntityTypeConfiguration<nick_episode_seg_info>
    {
        public nick_episode_seg_infoMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ep_seg_segment_length, t.ep_seg_description, t.episode_nola, t.pif_nola, t.promotion_status, t.include_in_reports, t.ep_seg_segment_number, t.ep_seg_prog_type });

            // Properties
            this.Property(t => t.ep_seg_segment_length)
            ...
            this.ToTable("nick_episode_seg_info", "pdbnola");
