...
{
    public class louth_inter0_libraryMap : EntityTypeConfiguration<louth_inter0_library>
    {
        public louth_inter0_libraryMap()
        {
            // Primary Key
            this.HasKey(t => new { t.sched_id, t.type, t.start_date, t.end_date, t.dow, t.nolachoice, t.element_number });
            ...
            this.ToTable("louth_inter0_library");
