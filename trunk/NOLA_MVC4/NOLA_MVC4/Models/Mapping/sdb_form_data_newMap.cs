...
{
    public class sdb_form_data_newMap : EntityTypeConfiguration<sdb_form_data_new>
    {
        public sdb_form_data_newMap()
        {
            // Primary Key
            this.HasKey(t => new { t.tab_id, t.tab_type, t.bv_id, t.label });
            ...
            this.ToTable("sdb_form_data_new");
