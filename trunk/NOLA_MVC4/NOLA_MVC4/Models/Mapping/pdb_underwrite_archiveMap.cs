...
{
    public class pdb_underwrite_archiveMap : EntityTypeConfiguration<pdb_underwrite_archive>
    {
        public pdb_underwrite_archiveMap()
        {
            // Primary Key
            ...
            this.ToTable("pdb_underwrite_archive");
